...
# Configuración del entrenador de PyTorch Lightning con DDP
trainer = pl.Trainer(max_epochs=10, progress_bar_refresh_rate=50, gpus=torch.cuda.device_count(), accelerator='ddp')
